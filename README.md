...
<p style="margin-left: 2em;">- Socket, ObjectStream 기반 실시간 통신</p>
<p style="margin-left: 2em;">- 플레이어 입력 → 서버 처리 → 모든 클라이언트에 게임 상태 브로드캐스트</p>
<p style="margin-left: 2em;">- 클라이언트에서 서버에 입력 전송 (이동, 공격, 스킬, 재시작 등)</p>
<p style="margin-left: 2em;">- 서버에서 게임 로직 처리 (슬라임 이동, 충돌, 점수 계산 등)</p>
